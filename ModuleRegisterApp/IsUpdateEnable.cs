...
namespace ModuleRegisterApp
{
    public class IsUpdateEnable
    {
        ...
        public IsUpdateEnable()
        {
            try
            {
                config = Config.LoadConfig(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Verson.xml"));
                ...
                RemoteFile rf = ParseRemoteXml(Path.Combine(config.ServerUrl, "Verson.xml"));
