...
{
	public partial class ReservationBigCartonFrm : Form
	{
		...
		public ReservationBigCartonFrm()
		{
			InitializeComponent();
		}

		public ReservationBigCartonFrm(UserInfo u)
		{
			InitializeComponent();
			InitializeDataTable();
			txtQty.Text = "0/0";
		...
		private void Carton_txt_KeyDown(object sender, KeyEventArgs e)
		{
            ...
            if (txtCartonBig.Text.Substring(8, 1) != "L")
            {
...
GROUP BY carton_big_id,model";
		...
		private void TxtCarton_KeyDown(object sender, KeyEventArgs e)
		{
            ...
            if (txtCarton.Text.Substring(8, 1) != "R")
            {
                MessageBox.Show("Wrong format!");
                return;
            }
...
GROUP BY carton_id,type,model";
		...
		{
            //string tmp = dbFaci.GetNewCartonId("carton_big","L");
            string tmp = dbFaci.GetNewId("L");
